...
- Для `#catalog` добавлена лёгкая анимация фона: класс `.catalog-animated-bg` добавляет `::after` слой с `fon.webp` и анимацией `leavesFloat` (мягкое плавание + лёгкий blur).
